...
const Category = () => {
  return (
    <div class="grid grid-cols-6 gap-2 mr-4 ml-4 mt-2 sm:grid-rows-4 2xl:grid-cols-8 2xl:mr-10 2xl:ml-10">
        <div class="col-span-3 h-36 sm:row-span-2 sm:h-auto l 2xl:col-span-4 bg-blue-200">
        ...
        <div class="col-span-3 h-36 sm:row-span-1 sm:h-auto 2xl:col-span-2 2xl:row-span-2 bg-red-200">
            <div className='flex justify-center items-center flex-col h-full'>
        ...
        <div class=" col-span-3 h-36 sm:row-span-1 sm:h-auto 2xl:col-span-2 2xl:row-span-2 bg-green-200">
            <div className='flex justify-center items-center flex-col h-full'>
        ...
        <div class="col-span-3 h-36  sm:h-aut 2xl:col-span-2 2xl:row-span-2 2xl:min-h-[300px]   bg-pink-200">
            <div className='flex justify-center items-center flex-col h-full'>
        ...
        <div class="col-span-3 h-36 sm:row-span-2 sm:h-auto 2xl:col-span-2  bg-yellow-200">
            <div className='flex justify-center items-center flex-col h-full'>
        ...
        <div class="col-span-3 h-36 sm:row-span-1 2xl:col-span-4 2xl:row-span-2 2xl:h-auto bg-gray-200">
            <div className='flex justify-center items-center flex-col h-full'>
